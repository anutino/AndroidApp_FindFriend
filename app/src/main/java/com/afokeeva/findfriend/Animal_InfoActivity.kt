...
class Animal_InfoActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.afokeeva.findfriend.R.layout.activity_animal_info)
        ...
        val pager = findViewById<ViewPager2>(com.afokeeva.findfriend.R.id.viewPager2Images)
...
class ViewPagerAdapter(imagesList: List<String>) : RecyclerView.Adapter<ViewPagerAdapter.PagerVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerVH =
        PagerVH(LayoutInflater.from(parent.context).inflate(
    ...
    override fun onBindViewHolder(holder: PagerVH, position: Int) {
        var iv = holder.itemView.findViewById<ImageView>(com.afokeeva.findfriend.R.id.itemImageViewAnimal)

...
class AnimalInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val pager = view.findViewById<ViewPager2>(R.id.viewPager2Images)
        pager.orientation = ViewPager2.ORIENTATION_HORIZONTAL
        pager.adapter = MediaViewPager2(imagesList)
        var names = view.findViewById<TextView>(R.id.animalInfo_name_age_id)
        names.text = "Doggi, 1.2"
        var description = view.findViewById<TextView>(R.id.animalInfo_description)
